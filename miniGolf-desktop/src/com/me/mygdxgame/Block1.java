...
public class Block1 {
	...
	public Block1(Vector2 pos, BlockType blockType, FacingDir dir) {
		...
		case WALL:
			switch (dir) {
			case SOUTH:
				coords = new float[] { 0, 0, SIZE, 0, SIZE, SIZE / 2, 0,
						SIZE / 2 };
				break;
			case NORTH:
				coords = new float[] { 0, SIZE, SIZE, SIZE, SIZE, SIZE / 2, 0,
						SIZE / 2 };
				break;
			case WEST:
				coords = new float[] { 0, 0, 0, SIZE, SIZE / 2, SIZE, SIZE / 2,
						0 };
				break;
			case EAST:
				coords = new float[] { SIZE, 0, SIZE / 2, 0, SIZE / 2, SIZE,
						SIZE, SIZE };
				break;
			default:
				break;
